...
df <- df %>%
  ...
  mutate(stem_job_4 = ocupacao == "engenheiro" | ocupacao == "biomedico"| ocupacao == "quimico" | ocupacao == "biologo" | ocupacao == "estatistico" | ocupacao == "tecnico em informatica" | ocupacao == "astronomo"| ocupacao == "matematico e atuario" | ocupacao == "fisico" | ocupacao == "programador de computador")
...
#df <- df %>% 
#  mutate(cbo_agregado_nome = recode(ocupacao,
#                                    "medico" = "Doctor",
#                                    .default = cbo_agregado_nome))
#
...
saveRDS(df, file = paste(work_dir, "/output/data/rdd_data_tsedefinition.rds", sep = ""))
